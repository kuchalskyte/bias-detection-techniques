...
visualise_errors <- function(data, variable1 = "Colour", variable2 = "Disability", 
                             pos_error, neg_error) {
...
was_analysis_heat <- function(societies, formula = "Outcome ~ Income + Education") {
  ...
  #      heatmap_pos: Heatmap visualization for normalized positive Wasserstein distances;
  #      heatmap_neg: Heatmap visualization for normalized negative Wasserstein distances;
  ...
  # Normalize the positive and negative Wasserstein distances
